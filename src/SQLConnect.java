...
public class SQLConnect {
        ...
        try
    {
        Connection con=DriverManager.getConnection(
                "jdbc:mysql://localhost:3306/mydb2","root","root");  // establishing connection with db
   ...
   /* public static void InsertStatement( String Name) {
        ...
        {
            Connection con=DriverManager.getConnection(
                    "jdbc:mysql://localhost:3306/mydb","root","root");  // establishing connection with db
    ...
    public static void PrintTable(){
        try{
        Connection con=DriverManager.getConnection(
                "jdbc:mysql://localhost:3306/mydb2","root","root");
